...
const BlogPostTemplate = ({ data: { site, mdx: page, allMdx: childPages }, children, location }) => {
  ...
  return (
    <Layout location={location} title={siteTitle}>
      <article className={`page ${PageStyles.pageLayout}`} itemScope itemType="http://schema.org/Article">
        {!page.frontmatter.isHome ? (
          <>
            <header className={PageStyles.header}>{pageHeading}</header>
