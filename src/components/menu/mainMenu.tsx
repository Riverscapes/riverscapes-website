        ...
        {menu.map((link, key) =>
          link.items ? (
            <React.Fragment key={key}>
              ...
              >
                <Button component={Link} to={link.url} key={key} className={menuStyles.menuButton}>
                  {link.title}
                </Button>
                <Button
                  id={`${key}`}
              ...
              >
                <ClickAwayListener onClickAway={handleClose}>
                  <Paper square className={menuStyles.paperMenu}>
                    {link.items.map((dropdownItem, itemIndex) => (
                      <MenuItem key={itemIndex} onClick={handleClose} className={menuStyles.dropdownMenuItem} divider>
                        <Link to={dropdownItem.url} className={menuStyles.dropdownMenuItemLink}>
                          <KeyboardArrowRightIcon fontSize="small" className={menuStyles.menuIcon} />
                          {dropdownItem.title}
                        </Link>
                      </MenuItem>
                    ))}
